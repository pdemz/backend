...
public class FacebookHelper {
	...
	public static void test(){
		...
		FacebookClient fbClient = new DefaultFacebookClient(myAccessToken, myAppSecret);
		JsonObject pooper = fbClient.fetchObject("10205412806304974", JsonObject.class, Parameter.with("fields", "context.fields(mutual_friends)"));
		System.out.println(pooper.getJsonObject("context").getJsonObject("mutual_friends").getJsonObject("summary").getString("total_count").toString() + "mutual friends");
